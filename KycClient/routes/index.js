...
const {addUserData,verifyUser,checkPoliceKey,getData,changeUserKey,} = require("./kycClient");
const fetch = require("node-fetch");
const {getUserPublicKey,getUserAddress,decrypt,} = require("./lib/transaction");
