const {getUserPublicKey,getState,encrypt,getUserAddress,decrypt} = require('./lib/transaction')
const { createTransaction } = require('./lib/processor')
FAMILY_NAME = 'Kyc Chain'

let POLICEKEY = ['027f3250f50c1257f0314d4d3b7f21af937c4d8b2c1e020f4d2692d0b6c0562f2d']

function addUserData(Key,pub_key,enKey,name,email,dob,location,mobile,pincode,aadhar,Voter)
{
  let address = getUserAddress(pub_key)
  let payload = [name,email,dob,location,mobile,pincode,aadhar,getUserPublicKey(Key),Voter]
